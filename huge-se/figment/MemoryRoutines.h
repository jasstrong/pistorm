...
#define memoryRoutinesIncludes
	...
	void c_InitZone(GrowZoneProcPtr	pgrowZone, long cmoreMasters, void* limitPtr, void* startPtr);
	...
	Handle c_RecoverHandle(unsigned long trapWord, const Ptr doomedBlock);
	...
	Size c_PurgeSpace(unsigned long trapWord, Size* contig);	/* returns total as result */
	...
	#ifdef StarTrek
pascal void InitZone(GrowZoneProcPtr	pgrowZone, long cmoreMasters, void* limitPtr, void* startPtr);
